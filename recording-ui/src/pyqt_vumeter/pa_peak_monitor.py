...
class PAPeakMonitorException(Exception):
    pass

class PAPeakMonitor(object):
    """
    Adapted from:
    http://freshfoo.com/blog/pulseaudio_monitoring

    Allows for the monitoring of pulseaudio sinks.
    """
    ...
    def context_notify_cb(self, context, _):
        ...
        if state == PA_CONTEXT_READY:
            ...
            raise PAPeakMonitorException("Connection Failed.")
        elif state == PA_CONTEXT_TERMINATED:
            raise PAPeakMonitorException("Connection Terminated.")
...
#def main():
    #monitor = PAPeakMonitor(SINK_NAME, METER_RATE)
